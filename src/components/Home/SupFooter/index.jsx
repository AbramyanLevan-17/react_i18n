    ...
    <div className='supfooter'>
      <div className="supfooter__left">
        ...
        <div className="supfooter__wrapper">
          <div className="supfooter__lable">Don't miss out...</div>
          <div className="supfooter__title">Get Started Today!</div>
          <div className="supfooter__button"><span>Sign up</span></div>
        </div>
      </div>
      <div className="supfooter__right">
        ...
        <div className="supfooter__wrapper">
          <div className="supfooter__lable">Our support team is available 24/7</div>
          <div className="supfooter__title">Any Questions?</div>
          <div className="supfooter__button"><span>Support</span></div>
        </div>
      </div>
    </div>
  )
